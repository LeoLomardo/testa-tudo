...
void calculateCRC(char *message, char *generator, FILE *arquivo, char *resultado) {
    ...
    char dividend[msgLen + genLen]; // Alocar espaço suficiente para a mensagem aumentada
    char quotient[msgLen + 1]; // Quociente terá o mesmo tamanho da mensagem original
    ...
    // Copiar o resto final para a variável resultado
